...
"""
 Script for sorting images in a folder into subfolders, version 2. This script launches a GUI which displays
 one image after the other and lets the user vote for different given labels from a list given as input to the
 script. In contrast to original version, version 2 allows for relabelling and keeping track of the labels.
 USAGE:
 python sort_folder_vers2.py
 ...
 changes, version 2: Nestor Arsenov (nestorarsenov@gmail.com)
 Date: 24. Dec 2018
"""
